    ...
    try {
        ...
        await db.exec(`
            ...
            VALUES 
                ...
                ('Dent de Crolles','Ce sommet emblématique de la Chartreuse, offre un panorama exceptionnel jusqu'à sa cime surplombant la vallée de. Au cœur du parc naturel régional de Chartreuse, ce promontoire perché à 2062 mètres d'altitude est une destination privilégiée pour les amoureux de la nature et de la rando.',4.5,'Route du Col du Coq, 38660 Plateau-des-Petites-Roches','./public/styles/images/dent_de_crolles.jpg'),
                ('Lac Achard', 'Une randonnée en plein nature aux portes de Grenoble. Le sentier vous mène à travers bois au Lac Archard où il fait bon flâner. Puis, dans un milieu plus dégagé, le chemin vous fait monter jusqu'aux Lacs Robert.', 4, '623 Route de la Croisette, 38410 Chamrousse', './public/styles/images/lac_achard.jpg'),
